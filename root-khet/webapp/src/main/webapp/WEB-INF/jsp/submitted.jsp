...
<html>
<head>
<!-- 			<link rel="stylesheet" type="text/css" href="/resources/css/probando.css"> -->
<%-- 		    <spring:url value="/resources/css/probando.css" var="submittedCSS" /> --%>
<%-- 		    <link href="${submittedCSS}" rel="stylesheet" /> --%>
<%-- 		    <link href="<c:url value="/resources/css/probando.css" />" rel="stylesheet"> --%>
<!--    			<link rel="stylesheet" type="text/css" href="/resources/probando.css"> -->
