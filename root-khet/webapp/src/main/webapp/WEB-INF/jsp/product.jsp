...
<head>
    ...
    <title><spring:message code="productPage.title" arguments="${fn:toUpperCase(fn:substring(product.name, 0, 1))}${fn:substring(product.name, 1,fn:length(product.name))}"/></title>
    <link
