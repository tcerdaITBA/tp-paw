...
public class ProfileCustomizeController {
	...
	public ModelAndView changePassword(@Valid @ModelAttribute("changePasswordForm") final FormChangePassword changePasswordForm,
		...
		if (errors.hasErrors())
			return errorState(changePasswordForm, errors, attr);
	...
	private ModelAndView errorState(FormChangePassword changePasswordForm, BindingResult errors, RedirectAttributes attr) {
