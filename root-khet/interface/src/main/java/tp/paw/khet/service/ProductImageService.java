...
public interface ProductImageService {
	...
	/**
	 * Creates a {@link List} of {@link ProductImage} associated with a
	 * {@link Product}
	 * 
	 * @param imageBytes
	 *            - list of byte arrays of the images data
	 * @param productId
	 *            - ID of the product the images belong to
	 ...
	 * @param productId
	 *            - ID of the product
	 * @return {@link List} with the product images ID. Could be empty if the
	 *         product possesses no images
	 */
	 ...
	 * @param productId
	 *            - ID of the product the image belongs to
	 * @return The image associated with the given IDs or null if it doesn't
	 *         exist
	 */
