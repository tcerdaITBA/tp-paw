...
public interface VoteService {
	 ...
	 * 
	 * @param productId
	 *            - ID of the product to vote
	 * @param userId
	 *            - ID of the voter
	 * @return true if the product was successfully voted and was not prevously
	 ...
	 * 
	 * @param productId
	 *            - ID of the product to unvote
	 * @param userId
	 *            - ID of the user who wants to remove his/her vote
	 * @return true if the product was successfully unvoted and was prevously
	 *         voted, false otherwise
	 */
	 ...
	 *            - ID of the product to unvote
	 * @param userId
	 *            - ID of the user who wants to toggle it's vote
	 ...
	 * 
	 * @param product
	 *            - The {@link Product} which votes to retrieve
	 * @param votersToShow
	 *            - Maximum number of voters to retrieve
