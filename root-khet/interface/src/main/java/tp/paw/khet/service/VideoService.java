...
public interface VideoService {
	...
	/**
	 * Creates a {@link List} of {@link Videos} associated with a {@link Product}
	 * @param videoIds - List composed by IDs of the videos
	 * @param productId - ID of the product the videos belong to
