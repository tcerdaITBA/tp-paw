...
public interface CommentService {
	 ...
	 * @param productId
	 *            - ID of the {@link Product} this comment belongs to
	 * @param userId
	 *            - ID of the {@link User} the posted this comment
	 ...
	 *            - Content of the comment
	 * @param parentId
	 *            - ID of the {@link Comment} this comment is associated with
	 * @param productId
	 *            - ID of the {@link Product} this comment belongs to
	 * @param userId
	 *            - ID of the {@link User} the posted this comment
	...
	/**
	 * Retrieves a {@link List} of parent comments sorted by post date and
	 * associated with it's corresponding child comments.
	 * 
	 * @param productId
	 *            - ID of the product the comments belong to
